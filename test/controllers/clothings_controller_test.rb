...
class ClothingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post clothings_url, params: { clothing: { brand_id: @clothing.brand_id, color: @clothing.color, description: @clothing.description, name: @clothing.name, type_id: @clothing.type_id } }
    end
  ...
  test "should update clothing" do
    patch clothing_url(@clothing), params: { clothing: { brand_id: @clothing.brand_id, color: @clothing.color, description: @clothing.description, name: @clothing.name, type_id: @clothing.type_id } }
